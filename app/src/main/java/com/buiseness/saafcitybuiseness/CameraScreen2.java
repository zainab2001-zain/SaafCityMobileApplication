    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(CameraScreen2.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    // Request runtime permission
                    ActivityCompat.requestPermissions(CameraScreen2.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 100);
                } else {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (image1.equals(null)){
                    ...
                    Toast.makeText(CameraScreen2.this, "Please Upload the Photo from Camera or Gallery!", Toast.LENGTH_SHORT).show();
                }
                else{
                    AlertDialog.Builder builder = new AlertDialog.Builder(CameraScreen2.this);
...
// Get the logged-in user's email
        String complaintid =  getComplaintIdFromSharedPreferences(); // Replace with the logged-in user's email

// Call the uploadImage() method on your ApiService interface
        Call<ComplaintResponse> call = apiService.uploadVerificationImage(complaintid, filePart);
            ...
            public void onResponse(Call<ComplaintResponse> call, retrofit2.Response<ComplaintResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    if (uploadResponse.isSuccess()) {
                        ...
                        Intent intent = new Intent(CameraScreen2.this,FeedbackScreen.class);
                        ...
                        String message = uploadResponse.getMessage();
                        //Toast.makeText(CameraScreen2.this, "COMPLAINT SIZE: " + lengthofcomplaints, Toast.LENGTH_SHORT).show();
                        Log.e("Upload", "Error uploading image: " + message);
                    }
                } else {
                    // Handle error response
                    Log.e("Upload", "respomse successful API call failed: " + response.message());
                }
            }
